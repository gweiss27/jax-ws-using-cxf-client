 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://service.javaws.javaee.java.gregoryweiss.io/", wsdlLocation = "http://localhost:8080/services/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://service.javaws.javaee.java.gregoryweiss.io/", "HelloWorldService");
    ...
    public HelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://service.javaws.javaee.java.gregoryweiss.io/", "HelloWorldPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.javaws.javaee.java.gregoryweiss.io/", "HelloWorldPort"), HelloWorld.class, features);
    }
